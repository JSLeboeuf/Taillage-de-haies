...
| Je veux... | Lire |
|------------|------|
| **Trouver une entreprise à acheter** | [Quick Ref: Prospection](quick-ref/01-prospection.md) |
| **Évaluer si c'est un bon deal** | [Quick Ref: Évaluation](quick-ref/02-evaluation.md) |
| **Négocier avec le vendeur** | [Quick Ref: Négociation](quick-ref/03-negociation.md) |
| **Financer sans cash** | [Quick Ref: Financement](quick-ref/04-financement.md) |
| **Augmenter les profits après achat** | [Quick Ref: Optimisation](quick-ref/05-optimisation.md) |
| **Protéger mes actifs** | [Quick Ref: Protection](quick-ref/06-protection.md) |
| **Préparer une sortie (exit)** | [Quick Ref: Exit](quick-ref/07-exit.md) |

---

## Playbook Complet (Lecture Linéaire)

**Pour suivre le processus complet étape par étape:**
→ [PLAYBOOK.md](PLAYBOOK.md)

---

## Frameworks Détaillés par Auteur

### Alex Hormozi ($100M Series)
| Document | Concepts Clés |
|----------|---------------|
| [hormozi-100m-trilogy.md](frameworks/hormozi-100m-trilogy.md) | Value Equation, Grand Slam Offer, Lead Magnets |

**Utiliser quand:** Pricing, création d'offres irrésistibles, marketing

### Codie Sanchez (Main Street Millionaire)
| Document | Concepts Clés |
|----------|---------------|
| [codie-sanchez-main-street-millionaire.md](frameworks/codie-sanchez-main-street-millionaire.md) | R.I.C.H., Deal Box, Profit Payback, Seller Financing |

**Utiliser quand:** Trouver deals, évaluer entreprises, négocier avec vendeurs

### Roland Frasier
| Document | Concepts Clés |
|----------|---------------|
| [roland-frasier-business-wealth.md](frameworks/roland-frasier-business-wealth.md) | ACQUIREpreneur, $0 Out-of-Pocket, Roll-ups, EPIC |
| [roland-frasier-asset-protection.md](frameworks/roland-frasier-asset-protection.md) | LLC, Trusts, Structures légales, 4 fronts de défense |
...
| Document | Concepts Clés |
|----------|---------------|
| [playbook-acquisition-taillage-quebec.md](frameworks/playbook-acquisition-taillage-quebec.md) | Scripts FR, Checklist 90 jours, Contexte local |

**Utiliser quand:** Exécution terrain au Québec
...
- **Trouver vendeurs motivés**: [Codie](frameworks/codie-sanchez-main-street-millionaire.md#deal-sourcing) | [Frasier](frameworks/roland-frasier-business-wealth.md#les-10-raisons-de-motivation-des-vendeurs)
- **Évaluer une entreprise**: [Codie Deal Box](frameworks/codie-sanchez-main-street-millionaire.md#deal-box)
- **Financement vendeur**: [Codie](frameworks/codie-sanchez-main-street-millionaire.md#profit-payback) | [Frasier](frameworks/roland-frasier-business-wealth.md#étape-4-financer-le-deal)
- **$0 Out-of-Pocket**: [Frasier Business Wealth](frameworks/roland-frasier-business-wealth.md)
...
- **90+ méthodes d'optimisation**: [Frasier](frameworks/roland-frasier-business-wealth.md#les-90-méthodes-doptimisation)
- **Lead Generation**: [Hormozi Leads](frameworks/hormozi-100m-trilogy.md#leads)

### Protection & Structures
- **4 fronts de défense**: [Frasier Asset Protection](frameworks/roland-frasier-asset-protection.md#les-4-fronts-de-défense)
- **LLC vs Corporation**: [Frasier](frameworks/roland-frasier-asset-protection.md#outils-de-protection)
- **Trusts**: [Frasier](frameworks/roland-frasier-asset-protection.md#trusts)

### Exit & Vente
- **Multiples de sortie**: [Frasier](frameworks/roland-frasier-business-wealth.md#lexit-epic)
- **Roll-up strategy**: [Frasier](frameworks/roland-frasier-business-wealth.md#le-concept-de-roll-up)
- **Préparer exit**: [Frasier](frameworks/roland-frasier-business-wealth.md#chemin-3-sortie-epic)
...
|----------|--------|--------|
| Taux échec startups (5 ans) | 45-50% | Frasier |
| Taux succès acquisitions | 90% | Frasier |
| Entreprises à vendre qui ne vendent pas | 80% | Codie |
| Profit Payback idéal | <3 ans | Codie |
| Multiple achat PME | 2-4x EBITDA | Frasier |
| Multiple vente optimisée | 5-10x EBITDA | Frasier |
| Marge profit moyenne | 10% | Frasier |
| Marge profit "good" | 20%+ | Frasier |

---

## Scripts & Templates

- **Script approche propriétaire**: [Playbook Québec](frameworks/playbook-acquisition-taillage-quebec.md#scripts)
- **Lettre d'intention**: [Playbook Québec](frameworks/playbook-acquisition-taillage-quebec.md#templates)
- **Checklist due diligence**: [Codie](frameworks/codie-sanchez-main-street-millionaire.md#due-diligence)
- **Checklist 90 jours post-acquisition**: [Playbook Québec](frameworks/playbook-acquisition-taillage-quebec.md#90-jours)
...
| Auteur | Site | Contenu |
|--------|------|---------|
| Roland Frasier | BusinessWealthWithoutRisk.com/access | Worksheets, checklists, scripts |
| Jay Abraham | Abraham.com | Stratégies marketing |
| Codie Sanchez | ContrarianThinking.co | Newsletter acquisitions |
| Alex Hormozi | Acquisition.com | Contenu gratuit |
