...
|----------|--------|
| Commits totaux | 0 |
| Commits R&D identifiés | 0 |
| Ratio R&D | 0% |
| Heures R&D estimées | 0h |
| Salaire R&D estimé | $0 |
| Coûts API/infra | $235 |
| **Total dépenses admissibles** | **$235** |
| Crédit fédéral (35%) | $82 |
| Crédit CRIC (30%) | $70 |
| **Total crédits potentiels** | **$152** |
...
|---|--------|---------|-------------|
| 1 | Sophie — Réceptionniste IA vocale | 0 | 0h |
| 2 | Traducteur TET espagnol↔français | 0 | 0h |
| 3 | Optimisation routes prédictive | 0 | 0h |
| 4 | Scoring performance employés | 0 | 0h |
| 5 | Pipeline qualification leads IA | 0 | 0h |
...
|---------|-------------|----------------|
| Anthropic (Claude) | $80 | ___ $ |
| OpenAI (GPT-4) | $40 | ___ $ |
| Deepgram (STT) | $15 | ___ $ |
| ElevenLabs (TTS) | $20 | ___ $ |
| Vercel (hosting) | $20 | ___ $ |
| Supabase (DB) | $25 | ___ $ |
| Cloudflare Workers | $5 | ___ $ |
| Twilio (SMS/voice) | $30 | ___ $ |
| **Total** | **$235** | **___ $** |
